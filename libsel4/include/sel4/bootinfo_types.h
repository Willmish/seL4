...
typedef struct seL4_UntypedDesc {
    ...
    seL4_Uint8 isTainted;/* whether the untyped was used by the kernel */
    seL4_Uint8 padding[sizeof(seL4_Word) - 3 * sizeof(seL4_Uint8)];
} seL4_UntypedDesc;
...
#define SEL4_BOOTINFO_HEADER_BOOTINFO 7
#define SEL4_BOOTINFO_HEADER_NUM SEL4_BOOTINFO_HEADER_BOOTINFO + 1
